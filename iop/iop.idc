...
static Bytes_0(void) {
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0x4aa,	"FDC_sub_04AA");
	MakeCode	(0x4aa);
	MakeName	(0x4b6,	"SET_A_TO_6");
	MakeCode	(x=0x4b8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeCode	(0x520);
	MakeName	(0x52d,	"BUS_LATCH_sub_052D");
	MakeCode	(0x52d);
	MakeCode	(x=0x546);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeName	(0x11ed,	"orphan_sub_11ED");
	MakeCode	(x=0x11ed);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0x11f1);
	...
	MakeCode	(0x16f8);
	MakeName	(0x1705,	"FDC_SUBHANDLER02_WRITE_BUS");
	MakeCode	(0x1705);
	MakeCode	(x=0x1711);
	OpDecimal	(x,	1);
	MakeName	(0x1725,	"FDC_SUBHANDLER03_READ_BUS");
	MakeCode	(0x1725);
	MakeCode	(x=0x1731);
	OpDecimal	(x,	1);
	...
	MakeCode	(x=0x1770);
	OpDecimal	(x,	1);
	MakeName	(0x1781,	"FDC_HANDLER_COMMON_sub_1781");
	MakeCode	(0x1781);
	...
	OpHex		(x,	0);
	OpHex		(x,	1);
	MakeName	(0x1836,	"FDC_sub_1836");
	MakeCode	(x=0x1836);
	OpStroff	(x,	1,	GetStrucIdByName("IX_STRUCT"));
	MakeName	(0x183d,	"FDC_DMA_sub_183D");
	MakeCode	(0x183d);
	MakeCode	(x=0x1840);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpHex		(x,	0);
	OpHex		(x,	1);
	MakeName	(0x1864,	"FDC_DMA_sub_1864");
	MakeCode	(0x1864);
	MakeCode	(x=0x1867);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeCode	(x=0x1a2d);
	OpEnum		(x,	1,	GetEnum("PORTS"));
	MakeName	(0x1a32,	"ARR_5_DMA_ALL_0");
	MakeByte	(0x1a32);
	MakeArray	(0x1a32,	5);
	MakeName	(0x1a37,	"ARR_3_DMA_ALL");
	MakeByte	(0x1a37);
	MakeArray	(0x1a37,	3);
	MakeName	(0x1a3a,	"DMA_ALL_3_0");
	MakeByte	(0x1a3a);
	MakeArray	(0x1a3a,	2);
	MakeName	(0x1a3c,	"ARR_1_VAL_37");
	MakeByte	(0x1a3c);
	...
	MakeWord	(0x2263);
	MakeWord	(0x2266);
	MakeName	(0x22ea,	"FDC_IY_BUF_unk_22EA");
	MakeName	(0x2304,	"FDC_ARR_16_byte_2304");
	MakeByte	(0x2304);
	MakeArray	(0x2304,	16);
	...
	MakeByte	(0x2684);
	MakeArray	(0x2684,	3);
	MakeName	(0x2687,	"FDC_3_byte_2687");
	MakeByte	(0x2687);
	MakeName	(0x2688,	"FDC_byte_2688");
	MakeByte	(0x2688);
	MakeName	(0x2689,	"FDC_word_2689");
	MakeWord	(0x2689);
	MakeName	(0x268b,	"FDC_byte_268B");
	MakeByte	(0x268b);
	MakeName	(0x268c,	"FDC_SUB_COMMAND_BUFFER");
	MakeRptCmt	(0x268c,	"=== FDC COMMAND BUFFER === 11020");
	MakeByte	(0x268c);
	MakeByte	(0x268d);
	MakeByte	(0x268e);
	MakeByte	(0x268f);
	...
	MakeWord	(0x26d7);
	MakeByte	(0x26d9);
	MakeName	(0x26db,	"_0A_FROM_BEGINNING");
	MakeByte	(0x26db);
	MakeByte	(0x26dc);
	MakeWord	(0x26de);
	MakeWord	(0x26e0);
	...
	MakeByte	(0x26fe);
	MakeName	(0x26ff,	"ARR12_WIPED_FROM_BEGINNING");
	MakeByte	(0x26ff);
	MakeArray	(0x26ff,	12);
	MakeWord	(0x270b);
	MakeByte	(0x270e);
